      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">E-commerce</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-xl text-gray-600 mb-8">
              Plataformas de comercio electrónico robustas que impulsan tus ventas online.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Soluciones e-commerce</h2>
