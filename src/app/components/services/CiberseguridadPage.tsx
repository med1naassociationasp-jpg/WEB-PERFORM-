      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Ciberseguridad</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-xl text-gray-600 mb-8">
              Protección integral de datos y sistemas con las mejores prácticas de seguridad informática.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Soluciones de seguridad</h2>
