        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="bg-teal-100 p-4 rounded-xl">
              <Scale className="w-12 h-12 text-teal-600" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Sistemas de Pesaje</h1>
          </div>

          <div className="prose max-w-none">
            <p className="text-xl text-gray-600 mb-8">
              Soluciones industriales de pesaje y etiquetado para optimizar operaciones.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Sistemas especializados</h2>
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {[
                'Básculas industriales',
                'Sistemas de etiquetado',
                'Software de gestión de peso',
                'Integración con ERP',
